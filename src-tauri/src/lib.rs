    ...
    .invoke_handler({
      ...
      #[cfg(debug_assertions)]
      {
        tauri::generate_handler![
          ...
          commands::queue::set_queue_title,
          commands::queue::broadcast_queue_update,
          commands::queue::save_and_broadcast_queue,
          commands::promo::get_promo_state,
          commands::promo::save_promo_state,
          commands::promo::add_promo_item,
          commands::promo::remove_promo_item,
          commands::promo::update_promo_item,
          commands::promo::clear_promo,
          commands::promo::set_promo_settings,
          commands::promo::broadcast_promo_update,
          commands::promo::save_and_broadcast_promo,
          commands::brand::get_brand_settings,
